          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <input
                ...
                className="w-full bg-gray-800 text-gray-100 placeholder-gray-500 rounded-lg py-2 px-4 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent text-sm border border-gray-700"
              />
