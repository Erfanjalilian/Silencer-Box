      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">مقالات تخصصی</h2>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {articles.map((article) => (
            <article
              key={article.id}
              className="bg-black rounded-xl overflow-hidden border border-gray-800 hover:border-orange-500/50 transition-all duration-300 hover:transform hover:scale-105 group"
            >
                ...
                <div className="relative h-48 w-full overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900">
                  {hasImage(article) ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full">
                      <PhotoIcon className="h-16 w-16 text-orange-500/30 mb-2" />
                      <p className="text-gray-600 text-sm">تصویر در حال بارگذاری</p>
                    </div>
                  )}
              ...
              <div className="p-6">
                <Link href={`/articles/${article.id}`}>
                  <h3 className="text-xl font-bold text-white mb-3 hover:text-orange-400 transition-colors line-clamp-2">
                    {article.title}
                  </h3>
                </Link>
